...
output "db_instance_availability_zone" {
  ...
  value       = try(module.db.db_instance_availability_zone, "")
}

output "db_instance_endpoint" {
  description = "The connection endpoint"
  value       = try(module.db.db_instance_endpoint, "")
}

output "db_instance_hosted_zone_id" {
  description = "The canonical hosted zone ID of the DB instance (to be used in a Route 53 Alias record)"
  value       = try(module.db.db_instance_hosted_zone_id, "")
}

output "db_instance_id" {
  description = "The RDS instance ID"
  value       = try(module.db.db_instance_identifier, "")
}

output "db_instance_resource_id" {
  description = "The RDS Resource ID of this instance"
  value       = try(module.db.db_instance_resource_id, "")
}

output "db_instance_status" {
  description = "The RDS instance status"
  value       = try(module.db.db_instance_status, "")
}

output "db_instance_name" {
  description = "The database name"
  value       = try(module.db.db_instance_name, "")
}
...
output "db_instance_password" {
  ...
  value       = try(module.db.db_instance_master_user_secret_arn, "")
  sensitive   = true
}

output "db_instance_port" {
  description = "The database port"
  value       = try(module.db.db_instance_port, 0)
}
